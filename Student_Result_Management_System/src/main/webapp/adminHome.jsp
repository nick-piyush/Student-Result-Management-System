<%@include file="header.html"%>
    ...
    <body>
        ...
        <center><img src="logo.png" width="100" height="100">
            <img src="dgi.png" align="right" width="100" height="100"></center>
        <hr class="new1">
        <div class="w3-container">
            ...
            <div id="London" class="w3-container w3-border city">
                ...
                <style>
                    body {
                        background: -webkit-linear-gradient(left, #525acd, #070db0);
                        background: linear-gradient(to right, #3c5dab, #1d369c);
                    }
                </style>
   ...
   try
   {
    ...
    while(rs.next())
     ...
     %>
        ...
        <!-- <hr class="new1"> -->
        <center>
            <h5 style="color:#fff ;">Designed & Developed by Team DevSpace</h5>
        </center>
        <hr class="new1">
        <center>
            <h5 style="color:#fff ;">All Right Reserved @ Team DevSpace :: 2020-2024</h5>
        </center>
        <!-- <hr class="new1"> -->
        <br>
    </body>
